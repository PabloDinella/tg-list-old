...
'Record id': 'id do registro',
'Recuperar senha: http://localhost:8000/app/default/reset_pass?key=%(key)s': 'Recuperar senha: http://localhost:8000/app/default/reset_pass?key=%(key)s',
'Recuperar senha: http://localhost:8000/app/default/reset_password?key=%(key)s': 'Recuperar senha: http://localhost:8000/app/default/reset_password?key=%(key)s',
'Recuperar senha: http://localhost:8000/app/default/reset_password?key=%25%28key%29s': 'Recuperar senha: http://localhost:8000/app/default/reset_password?key=%25%28key%29s',
'Recuperar senha: http://localhost:8000/app/default/reset_password?key=%25%28keys%29s': 'Recuperar senha: http://localhost:8000/app/default/reset_password?key=%25%28keys%29s',
'Recuperar senha: reset_password/?key=%(key)s': 'Recuperar senha: reset_password/?key=%(key)s',
